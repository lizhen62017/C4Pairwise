...
integer nrp,nspm,ig,ntx,ntcx,            &!5
      ...
      ibgion,ienion,profile_mpi,lj1264,plj1264,          &!73 New2021
      ipb,inp,ntrelax,relaxing,dec_verbose,vdwmodel,     &!79
      csurften,ninterface,no_ntt3_sync,nkija,idistr,baroscalingdir, &!85
      nucat,icnste,ntcnste,ntrelaxe,                     &!89
      mask_from_ref,hidx, reservoir_exchange_step,ionstepvelocities, iextpot !94
...
common/mdi/nrp,nspm,ig, &                                               !3
      ...
      profile_mpi,lj1264,plj1264,ipb,inp,ntrelax,relaxing,dec_verbose,vdwmodel, &!79 New2021
      csurften,ninterface,no_ntt3_sync,nkija,idistr,baroscalingdir,     &!85
      nucat,icnste,ntcnste,ntrelaxe,                     &!89
      mask_from_ref,hidx, reservoir_exchange_step,ionstepvelocities, iextpot !94
